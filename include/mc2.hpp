...
public:
  // constructor
  MC2(Global& g) : BaseSolver(g.Mz, g.My, g.Mx)
  {
  }

  // interpolation with MC2 limiter
  void mc2int(float64 um, float64 uc, float64 up, float64& ul, float64& ur)
  {
  ...
  virtual void flux_field(float64 dt, Global& g, T_vector& ueb, T_vector& feb);
