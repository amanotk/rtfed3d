...
void debug_write(const char* filename, int dsize, T_array& array, T_shape lbound, T_shape ubound)
{
...
#ifdef _DEBUG_
#define DEBUG_WRITE_ARRAY((array), (filename)) debug_write_array(array, filename)
